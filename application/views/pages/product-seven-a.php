            ...
            <div id="dimensions" class="tab-pane fade active show">
                <div class="tab-pane-main">
                    <div class="col-lg-4 panel-details">
                        ...
                        <img id="imageDimensionReview" src="<?php echo base_url('assets/images/stepper/product-seven-a/shapes/product-7-A.png')?>">
                    ...
                    <div class="col-lg-8 panel-customization">
                        <div class="col-md-12 dimension-preview othershape">
                            ...
                            <div class="dimensions-img">
                                ...
                                <img id="imageShowingDimension" src="<?php echo base_url('assets/images/stepper/product-seven-a/rectangle.png')?>">
                            </div>
            ...
            <div id="cover" class="tab-pane fade show">
                <div class="tab-pane-main">
                    <div class="col-lg-4 panel-details">
                        ...
                        <img id="imageCoverReview" src="<?php echo base_url('assets/images/stepper/product-seven-a/shapes/product-7-A.png')?>">
                        <button class="btn product-preview-btn">
                            PRODUCT PREVIEW
                        </button>
                    </div>
            ...
            <div id="fill" class="tab-pane fade show">
                <div class="tab-pane-main">
                    <div class="col-lg-4 panel-details">
                        ...
                        <img id="imageFillReview" src="<?php echo base_url('assets/images/stepper/product-seven-a/shapes/product-7-A.png')?>">
                        <button class="btn product-preview-btn">
                            PRODUCT PREVIEW
                        </button>
                    </div>
            ...
            <div id="ties" class="tab-pane fade show">
                <div class="tab-pane-main">
                    <div class="col-lg-4 panel-details">
                        ...
                        <img id="imageTieReview" src="<?php echo base_url('assets/images/stepper/product-seven-a/shapes/product-7-A.png')?>">
                        <button class="btn product-preview-btn">
                            PRODUCT PREVIEW
                        </button>
                    </div>
                    <div class="col-lg-8 panel-customization">
                        <div class="col-md-4 ties-wrapper">
                            <div>
                                <img class="ties1" src="<?php echo base_url('assets/images/stepper/product-seven-a/tie/default/tie-1.png')?>">
                            </div>
                            <label><input type="radio" class="square-corner-radio" name="ties_radio" checked value="1">None</label>
                        </div>
                        <div class="col-md-4 ties-wrapper">
                            <div>
                                <img class="ties2" src="<?php echo base_url('assets/images/stepper/product-seven-a/tie/default/tie-2.png')?>">
                            </div>
                            <label><input type="radio" name="ties_radio" value="2">2 ties at sides</label>
                        </div>
                        <div class="col-md-4 ties-wrapper remove">
                            <div>
                                <img class="ties3" src="<?php echo base_url('assets/images/stepper/product-seven-a/tie/default/tie-3.png')?>">
                            </div>
                            <label><input type="radio" name="ties_radio" value="3">4 ties at sides</label>
                        </div>
                        <div class="col-md-4 ties-wrapper">
                            <div>
                                <img class="ties4" src="<?php echo base_url('assets/images/stepper/product-seven-a/tie/default/tie-4.png')?>">
                            </div>
                            <label><input type="radio" name="ties_radio" value="4">4 ties at front and back</label>
                        </div>
                        <div class="col-md-4 ties-wrapper remove">
                            <div>
                                <img class="ties5" src="<?php echo base_url('assets/images/stepper/product-seven-a/tie/default/tie-5.png')?>">
                            </div>
                            <label><input type="radio" name="ties_radio" value="5">4 ties at all corners</label>
                        </div>
                        <div class="col-md-4 ties-wrapper remove">
                            <div>
                                <img class="ties6" src="<?php echo base_url('assets/images/stepper/product-seven-a/tie/default/tie-6.png')?>">
                            </div>
                            <label><input type="radio" name="ties_radio" value="6">6 ties at sides and corners</label>
                        </div>
                    </div>   
                    <div class="clearfix"></div>
            ...
            <div id="confirm" class="tab-pane fade show">
                <div class="tab-pane-main">
                    <div class="col-lg-6 panel-details">
                        ...
                        <img id="imageConfirmReview" src="<?php echo base_url('assets/images/stepper/product-seven-a/shapes/product-7-A.png')?>">
                        <button class="btn product-preview-btn">
                            PRODUCT PREVIEW
                        </button>
                    </div>
                    <div class="col-lg-6 panel-customization confirm-wrapper">
                        <p><span>PRODUCT</span><span id="productreview">Custom Daybed Cushion</span></p>
...
<script src="<?php echo base_url(); ?>assets/custom/js/productsevena.js"></script>
