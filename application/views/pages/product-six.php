            ...
            <div id="shape" class="tab-pane fade in active show">
                <div class="tab-pane-main">
                    <div class="col-lg-4 panel-details">
                        ...
                        <img id="imageShapeReview" src="<?php echo base_url('assets/images/stepper/product-six/shapes/product-6-A.png')?>">
                    ...
                    <div class="col-lg-8 panel-customization">
                        <div class="col-md-4 shape-radio-wrapper">
                            <img src="<?php echo base_url('assets/images/stepper/product-six/modern-clean.png')?>">
                            <br>
                            <label><input type="radio" name="shape_radio" checked value="1">Modern Clean</label>
                        </div>
                        <div class="col-md-4 shape-radio-wrapper">
                            <img src="<?php echo base_url('assets/images/stepper/product-six/modern-tufted.png')?>">
                            <br>
                            <label><input type="radio" name="shape_radio" value="2">Modern Tufted</label>
                        </div>
                        <div class="col-md-4 shape-radio-wrapper">
                            <img src="<?php echo base_url('assets/images/stepper/product-six/modern-sectioned.png')?>">
                            <br>
                            <label><input type="radio" name="shape_radio" value="3">Modern Sectioned</label>
                        </div>
                        <div class="col-md-4 shape-radio-wrapper">
                            <img src="<?php echo base_url('assets/images/stepper/product-six/traditional-clean.png')?>">
                            <br>
                            <label><input type="radio" name="shape_radio" value="4">Traditional Clean</label>
                        </div>
                        <div class="col-md-4 shape-radio-wrapper">
                            <img src="<?php echo base_url('assets/images/stepper/product-six/traditional-tufted.png')?>">
                            <br>
                            <label><input type="radio" name="shape_radio" value="5">Traditional Tufted</label>
                        </div>
                        <div class="col-md-4 shape-radio-wrapper">
                            <img src="<?php echo base_url('assets/images/stepper/product-six/traditional-sectioned.png')?>">
                            <br>
            ...
            <div id="style" class="tab-pane fade show">
                <div class="tab-pane-main">
                    <div class="col-lg-4 panel-details">
                        ...
                        <img id="imageStyleReview" src="<?php echo base_url('assets/images/stepper/product-six/shapes/product-6-A.png')?>">
                        <button class="btn product-preview-btn">
                            PRODUCT PREVIEW
                        </button>
                    </div>
                    <div class="col-lg-8 panel-customization">
                        <div class="col-md-6 style-radio-wrapper waterfall">
                            <img src="<?php echo base_url('assets/images/stepper/product-six/structure/waterfall-edge.png')?>">
                            <br>
                        ...
                        <div class="col-md-6 style-radio-wrapper boxed">
                            <img src="<?php echo base_url('assets/images/stepper/product-six/structure/boxed-edge.png')?>">
                            <br>
            ...
            <div id="dimensions" class="tab-pane fade show">
                <div class="tab-pane-main">
                    <div class="col-lg-4 panel-details">
                        ...
                        <img id="imageDimensionReview" src="<?php echo base_url('assets/images/stepper/product-six/shapes/product-6-A.png')?>">
                        <button class="btn product-preview-btn">
                            PRODUCT PREVIEW
                        </button>
                    </div>
                    <div class="col-lg-8 panel-customization">
                        <div class="col-md-12 dimension-preview othershape">
                            ...
                            <div class="dimensions-img">
                                <!-- <img src="<?php echo base_url('assets/images/stepper/product-six/seat-selet-square.png')?>"> -->
                                <img id="imageShowingDimension" src="<?php echo base_url('assets/images/stepper/product-six/modern-clean.png')?>">
                            </div>
                        ...
                        <!-- <div class="col-md-12 dimension-preview trapezoid">
                            ...
                            <div class="trapezoid-dimensions-img">
                                <img src="<?php echo base_url('assets/images/stepper/product-six/trapezoidal.png')?>">
                            </div>
            ...
            <div id="cover" class="tab-pane fade show">
                <div class="tab-pane-main">
                    <div class="col-lg-4 panel-details">
                        ...
                        <img id="imageCoverReview" src="<?php echo base_url('assets/images/stepper/product-six/shapes/product-6-A.png')?>">
                        <button class="btn product-preview-btn">
                            PRODUCT PREVIEW
                        </button>
                    </div>
            ...
            <div id="fill" class="tab-pane fade show">
                <div class="tab-pane-main">
                    <div class="col-lg-4 panel-details">
                        ...
                        <img id="imageFillReview" src="<?php echo base_url('assets/images/stepper/product-six/shapes/product-6-A.png')?>">
                        <button class="btn product-preview-btn">
                            PRODUCT PREVIEW
                        </button>
                    </div>
            ...
            <div id="ties" class="tab-pane fade show">
                <div class="tab-pane-main">
                    <div class="col-lg-4 panel-details">
                        ...
                        <img id="imageTieReview" src="<?php echo base_url('assets/images/stepper/product-six/shapes/product-6-A.png')?>">
                        <button class="btn product-preview-btn">
                            PRODUCT PREVIEW
                        </button>
                    </div>
                    <div class="col-lg-8 panel-customization">
                        <div class="col-md-4 ties-wrapper">
                            <div>
                                <img class="ties1" src="<?php echo base_url('assets/images/stepper/product-six/tie/modern-clean/tie-1.png')?>">
                            </div>
                            <label><input type="radio" class="square-corner-radio" name="ties_radio" checked value="1">None</label>
                        </div>
                        <div class="col-md-4 ties-wrapper">
                            <div>
                                <img class="ties2" src="<?php echo base_url('assets/images/stepper/product-six/tie/modern-clean/tie-2.png')?>">
                            </div>
                            <label><input type="radio" name="ties_radio" value="2">2 at back corners</label>
                        </div>
                        <div class="col-md-4 ties-wrapper remove">
                            <div>
                                <img class="ties3" src="<?php echo base_url('assets/images/stepper/product-six/tie/modern-clean/tie-3.png')?>">
                            </div>
                            <label><input type="radio" name="ties_radio" value="3">2 ties at back</label>
                        </div>
                        <div class="col-md-4 ties-wrapper">
                            <div>
                                <img class="ties4" src="<?php echo base_url('assets/images/stepper/product-six/tie/modern-clean/tie-4.png')?>">
                            </div>
                            <label><input type="radio" name="ties_radio" value="4">4 ties at all corners</label>
                        </div>
                        <div class="col-md-4 ties-wrapper remove">
                            <div>
                                <img class="ties5" src="<?php echo base_url('assets/images/stepper/product-six/tie/modern-clean/tie-5.png')?>">
                            </div>
                            <label><input type="radio" name="ties_radio" value="5">4 ties at front and back</label>
                        </div>
                        <div class="col-md-4 ties-wrapper remove">
                            <div>
                                <img class="ties6" src="<?php echo base_url('assets/images/stepper/product-six/tie/modern-clean/tie-6.png')?>">
                            </div>
            ...
            <div id="confirm" class="tab-pane fade show">
                <div class="tab-pane-main">
                    <div class="col-lg-6 panel-details">
                        ...
                        <img id="imageConfirmReview" src="<?php echo base_url('assets/images/stepper/product-six/shapes/product-6-A.png')?>">
                        <button class="btn product-preview-btn">
                            PRODUCT PREVIEW
                        </button>
                    </div>
                    <div class="col-lg-6 panel-customization confirm-wrapper">
                        <p><span>PRODUCT</span><span id="productreview">Custom Chaise Cushion</span></p>
...
<script src="<?php echo base_url(); ?>assets/custom/js/productsix.js"></script>
