<!-- The Modal -->
<div class="modal trans-modal" id="trimmingModal">
      ...
      <div class="modal-content larger-modal">
        ...
        <div class="modal-body fabric-panel-modal">
            ...
            <ul class="nav nav-tabs fabric-panel-nav">
                <li class="active"><a data-toggle="tab" href="#fabrics-trim">FABRICS WELT</a></li>
                <li><a data-toggle="tab" href="#favorites-trim">FAVORITES</a></li>
            </ul>

            <div class="tab-content">
                <div id="fabrics-trim" class="tab-pane in active">
                ...
                <div id="favorites-trim" class="tab-pane">
                    <div class="col-lg-12">
                        <div class="col-lg-8 float-left">
                            <span class="color-label">COLORS</span>
                            <span class="color-icon"></span>
...
<div class="modal trans-modal" id="trimmingDetailsModal">
  <!-- <div class="modal fade" id="myModal"> -->
    <div class="modal-dialog modal-lg">
      <div class="modal-content larger-modal">
        ...
        <div class="modal-body fabric-panel-modal">
            ...
            <ul class="nav nav-tabs fabric-panel-nav">
                <li class="active"><a data-toggle="tab" href="#fabrics-details">TRIMMING DETAILS</a></li>
