        ...
        <div class="modal-body fabric-panel-modal">
            ...
            <div class="tab-content">
                ...
                <div class="scrollable-div">
                    <?php 
                        for($i = 1; $i <= 5; $i++) { ?>
                        <div class="col-lg-3 fabric-wrapper TestName<?php echo $i; ?> DetailView<?php echo $i; ?>">
                            <div class="fabric-inner">
                                <img src="<?php echo base_url('assets/images/fabric-sample-1.jpg')?>">
                            </div>
                            <span class="favorite-wrapper testname<?php echo $i; ?>" onClick='moveFabricToFavourite(<?php echo $i; ?>)'></span>
                            <div class="fabric-item-label">
                                <p class="fabric-item-name">Test Name <?php echo $i; ?></p>
                                <p class="fabric-item-code">CUS0001</p>
                                <button class="btn btn-default view-details-btn" onClick='openFabricDetailsModal(<?php echo $i; ?>)'>VIEW</button>
                            </div>
                        </div>
                    <?php } ?>
                </div>
                ...
                <div id="favorites" class="tab-pane">
                    ...
                    <div class="scrollable-div copyToFavourite">
  ...
  <!-- <div class="modal fade" id="myModal"> -->
    <div class="modal-dialog modal-lg">
      <div class="modal-content larger-modal">
        ...
        <!-- Modal Header -->
        <div class="modal-header">
          <h4 class="modal-title modal-fabric"></h4>
                ...
                <div id="fabrics-details" class="tab-pane in active">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-lg-8 float-left">
                            ...
                            <button class="btn btn-default view-details-btn use-btn fabric-detail-button">SELECT THIS FABRIC</button>
                        </div>
