...
<div class="modal" id="trimmingModal">
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content larger-modal">
        ...
        <div class="modal-header">
          <h4 class="modal-title">CHOOSE YOUR TRIMMING FABRIC</h4>
        ...
        <div class="modal-body fabric-panel-modal">
            ...
            <ul class="nav nav-tabs fabric-panel-nav">
                <li class="active"><a data-toggle="tab" href="#trimming">FABRICS WELT</a></li>
                <li><a data-toggle="tab" href="#trimmingFavorites">FAVORITES</a></li>
            </ul>

            <div class="tab-content">
                <div id="trimming" class="tab-pane in active">
                ...
                <div id="trimmingFavorites" class="tab-pane">
                    <div class="col-lg-12">
                        <div class="col-lg-8 float-left">
                            <span class="color-label">COLORS</span>
                            <span class="color-icon"></span>
...
<!-- Trimming Details Modal -->

<div class="modal" id="trimmingDetailsModal">
  <!-- <div class="modal fade" id="myModal"> -->
    <div class="modal-dialog modal-lg">
      <div class="modal-content larger-modal">
        ...
        <!-- Modal Header -->
        <div class="modal-header">
          <h4 class="modal-title">TRIMMING FABRIC NAME - CUS001</h4>
        ...
        <div class="modal-body fabric-panel-modal">
            ...
            <ul class="nav nav-tabs fabric-panel-nav">
                <li class="active"><a data-toggle="tab" href="#trimming-details">TRIMMING FABRIC DETAILS</a></li>
                <!-- <li><a data-toggle="tab" href="#favorites">FAVORITES</a></li> -->
            </ul>

            <div class="tab-content">
                <div id="trimming-details" class="tab-pane in active">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-lg-8 float-left">
                            ...
                            <button class="btn btn-default view-details-btn use-btn">USE THIS TRIMMING</button>
                        </div>
