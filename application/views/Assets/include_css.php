...
<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/dist/js/bootgrid/jquery.bootgrid.css">

<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/libs/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css">

<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/extra-libs/multicheck/multicheck.css"> -->

<!-- CSS For Multicheck in Announcement Page Modal -->
<!-- <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/libs/select2/dist/css/select2.min.css">
<link href="<?php echo base_url('assets/extra-libs/DataTables/css/dataTables.bootstrap.min.css')?>" rel="stylesheet"> -->

<!-- Extra Libs From Employee-Active Page -->
