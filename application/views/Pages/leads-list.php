...
<body>
                        ...
                        <div class="card">
                            <div class="card-body">  
                                <div align="right">
                                    ...
                                    <button type="button" id="add_button" data-toggle="modal" data-target="#add_lead_modal" class="btn btn-info btn-md jsr-btn-add">Add</button>

                                    <button type="button" id="assign_leads_button"  class="btn btn-info btn-md jsr-btn-add">Assign Leads</button>
                                </div>
                                <div class="table-responsive">
                                    <table id="lead_all_table" class="table table-striped table-bordered" style="width:100%;">
                                        <thead>
                                            <tr>
    ...
    <?php $this->view('Components/Modals/call-description-timeline.php') ?>
...
$(document).ready(function(){	
	init('lead_all_table', GET_ALL_LEADS_API, '');
});
