...
<body>
             ...
             <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">A-One Leads</h4>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">  
                                <div align="right">
                                    <button type="button" id="download_format_button" class="btn btn-info btn-md jsr-btn-add" style="margin-right: 5px"><a href="<?php echo base_url(); ?>assets/crm-files/upload_bulk_leads.csv" download style="color: #fff">Format</a></button>

                                    <button type="button" id="import_leads_button" data-toggle="modal" data-target="#import_modal" class="btn btn-info btn-md jsr-btn-add" style="margin-right: 5px">Import</button>

                                    <button type="button" id="fetch_aone_leads_button" onclick="fetchSelfLeads('AONE')" class="btn btn-info btn-md jsr-btn-add">Fetch A-One Leads</button>

                                    <button type="button" id="assign_leads_button"  class="btn btn-info btn-md jsr-btn-add">Assign Leads</button>
                                </div>
                                <div class="table-responsive">
                                    <table id="lead_aone_table" class="table table-striped table-bordered" style="width:100%;">
                                        <thead>
                                            <tr>
    ...
    <?php $this->view('Components/Modals/import-leads.php') ?>
    <?php $this->view('Components/Modals/import-leads-result.php') ?>
...
$(document).ready(function(){	
	init('lead_aone_table', GET_AONE_LEADS_API, 'AONE');
});
