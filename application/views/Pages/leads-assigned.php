             ...
             <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Assigned Leads</h4>
                        ...
                        <div class="card">
                            <div class="card-body">  
                                ...
                                <div class="table-responsive">
                                    <table id="lead_assigned_table" class="table table-striped table-bordered" style="width:100%;">
                                        <thead>
                                            <tr>
...
$(document).ready(function(){	
	init('lead_assigned_table', GET_ASSIGNED_LEADS_API , '');
});
