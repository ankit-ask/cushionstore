             ...
             <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Leads Idle For 30 Days</h4>
                        ...
                        <div class="card">
                            <div class="card-body">  
                                <div align="right">
                                    ...
                                    <button type="button" id="assign_leads_button"  class="btn btn-info btn-md jsr-btn-add">Re-Assign Leads</button>
                                </div>
                                <div class="table-responsive">
                                    <table id="lead_idle_table" class="table table-striped table-bordered" style="width:100%;">
                                        <thead>
                                            <tr>
...
$(document).ready(function(){	
	init('lead_idle_table',GET_IDLE_LEADS_API,'');
});
