             ...
             <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Follow-Up Leads</h4>
                        ...
                        <div class="card">
                            <div class="card-body">  
                                ...
                                <div class="table-responsive">
                                    <table id="lead_followup_table" class="table table-striped table-bordered" style="width:100%;">
                                        <thead>
                                            <tr>
...
$(document).ready(function(){	
	init('lead_followup_table',GET_FOLLOWUP_LEADS_API,'');
});
