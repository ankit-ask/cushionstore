...
<body>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div align="right">
                                    <button type="button" id="add_sms_template_button" data-toggle="modal" data-target="#add_sms_template_modal" class="btn btn-info btn-lg jsr-btn-add">Add</button>
                                </div>
                                <div class="table-responsive">
                                <table id="sms_template_table" class="table table-striped table-bordered" style="width:100%;">
                                        <thead>
                                            <tr>
                                                <th>Template Id</th>
                                                <th>Category</th>
    ...
    <!-- Modals -->
    <?php $this->view('Components/Modals/add-sms-template.php')?>

    <!-- Include Scripts Files -->
    <?php $this->view('Assets/include_script.php')?>
    <script src="<?php echo base_url(); ?>assets/custom/js/sms-template-service.js"></script>

<script type="text/javascript">

$(document).ready(function(){

    init('sms_template_table',GET_SMS_TEMPLATE_API);
