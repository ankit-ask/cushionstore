             ...
             <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">DND Leads</h4>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">  
                                ...
                                <button type="button" id="assign_leads_button" data-toggle="modal" data-target="#assign_leads_modal" class="btn btn-info btn-md jsr-btn-add">Re-Assign Leads</button>

                                <button type="button" id="delete_leads_button" data-toggle="modal" data-target="#delete_leads_modal" class="btn btn-danger btn-md jsr-btn-add">Delete Leads Permanently</button>

                                </div>
                                <div class="table-responsive">
                                    <table id="lead_disposed_table" class="table table-striped table-bordered" style="width:100%;">
                                        <thead>
                                            <tr>
...
$(document).ready(function(){	
	init('lead_disposed_table', GET_DISPOSED_LEADS_API, '');
});
