             ...
             <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Web Leads</h4>
                        ...
                        <div class="card">
                            <div class="card-body">  
                                <div align="right">
                                    ...
                                    <button type="button" id="fetch_web_leads_button" onclick="fetchSelfLeads('WEB')" class="btn btn-info btn-md jsr-btn-add">Fetch Web Leads</button>

                                    <button type="button" id="assign_leads_button"  class="btn btn-info btn-md jsr-btn-add">Assign Leads</button>
                                </div>
                                <div class="table-responsive">
                                    <table id="lead_web_table" class="table table-striped table-bordered" style="width:100%;">
                                        <thead>
                                            <tr>
...
$(document).ready(function(){	
	init('lead_web_table', GET_WEB_LEADS_API, 'WEB');
});
