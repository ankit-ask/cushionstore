$(document).ready(function () {
	...
	$('#imageShapeReview').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/shapes/product-3-A.png');
	$('#imageStyleReview').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/shape-structure/product-3-A-waterfall.png');
	$('#imageDimensionReview').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/shape-structure/product-3-A-waterfall.png');
	$('#imageCoverReview').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/shape-structure/product-3-A-waterfall.png');
	$('#imageFillReview').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/shape-structure/product-3-A-waterfall.png');
	$('#imageTieReview').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/shape-structure/product-3-A-waterfall.png');
	$('#imageConfirmReview').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/shape-structure/product-3-A-waterfall.png');
	$('#imageShowingDimension').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/square.png');
	...
	var data = {
		'product-3':
		{
			...
			'ties': { 'type': 'None' },
			'productName': 'Custom Bench Back Pads'
		}
	}
...
var setShapeReviewImage = (c) => {
	switch (c) {
		case 1:
			...
			$('.ties1').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/tie/square/tie-1.png');
			$('.ties2').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/tie/square/tie-2.png');
			$('.ties3').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/tie/square/tie-3.png');
			$('.ties4').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/tie/square/tie-4.png');
			$('.ties5').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/tie/square/tie-5.png');
			$('.ties6').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/tie/square/tie-6.png');
			...
			break;
		case 2:
			$('#imageShapeReview').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/shapes/product-3-B.png');
			$('#imageStyleReview').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/shape-structure/product-3-B-waterfall.png');
			$('#imageDimensionReview').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/shape-structure/product-3-B-waterfall.png');
			$('#imageCoverReview').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/shape-structure/product-3-B-waterfall.png');
			$('#imageFillReview').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/shape-structure/product-3-B-waterfall.png');
			$('#imageTieReview').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/shape-structure/product-3-B-waterfall.png');
			$('#imageConfirmReview').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/shape-structure/product-3-B-waterfall.png');
			$('#imageShowingDimension').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/top-rounded-corners.png');

			// set shape to tie similar to selected shape
			$('.ties1').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/tie/rounded-top-corners/tie-1.png');
			$('.ties2').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/tie/rounded-top-corners/tie-2.png');
			$('.ties3').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/tie/rounded-top-corners/tie-3.png');
			$('.ties4').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/tie/rounded-top-corners/tie-4.png');
			$('.ties5').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/tie/rounded-top-corners/tie-5.png');
			$('.ties6').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/tie/rounded-top-corners/tie-6.png');
			...
			fetchedData['product-3'].shape.type = 'Rounded Top Corners';
			fetchedData['product-3'].structure.index = 1;
			...
			break;
		case 3:
			$('#imageShapeReview').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/shapes/product-3-C.png');
			$('#imageStyleReview').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/shape-structure/product-3-C-waterfall.png');
			$('#imageDimensionReview').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/shape-structure/product-3-C-waterfall.png');
			$('#imageCoverReview').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/shape-structure/product-3-C-waterfall.png');
			$('#imageFillReview').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/shape-structure/product-3-C-waterfall.png');
			$('#imageTieReview').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/shape-structure/product-3-C-waterfall.png');
			$('#imageConfirmReview').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/shape-structure/product-3-C-waterfall.png');
			$('#imageShowingDimension').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/all-rounded-corners.png');

			// set shape to tie similar to selected shape
			$('.ties1').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/tie/all-corners-rounded/tie-1.png');
			$('.ties2').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/tie/all-corners-rounded/tie-2.png');
			$('.ties3').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/tie/all-corners-rounded/tie-3.png');
			$('.ties4').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/tie/all-corners-rounded/tie-4.png');
			$('.ties5').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/tie/all-corners-rounded/tie-5.png');
			$('.ties6').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/tie/all-corners-rounded/tie-6.png');
			...
			break;
		case 4:
			$('#imageShapeReview').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/shapes/product-3-D.png');
			$('#imageStyleReview').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/shape-structure/product-3-D-waterfall.png');
			$('#imageDimensionReview').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/shape-structure/product-3-D-waterfall.png');
			$('#imageCoverReview').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/shape-structure/product-3-D-waterfall.png');
			$('#imageFillReview').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/shape-structure/product-3-D-waterfall.png');
			$('#imageTieReview').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/shape-structure/product-3-D-waterfall.png');
			$('#imageConfirmReview').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/shape-structure/product-3-D-waterfall.png');
			$('#imageShowingDimension').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/rounded-top.png');

			// set shape to tie similar to selected shape
			$('.ties1').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/tie/rounded-top/tie-1.png');
			$('.ties2').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/tie/rounded-top/tie-2.png');
			$('.ties3').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/tie/rounded-top/tie-3.png');
			$('.ties4').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/tie/rounded-top/tie-4.png');
			$('.ties5').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/tie/rounded-top/tie-5.png');
			$('.ties6').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/tie/rounded-top/tie-6.png');
			...
			break;
		case 5:
			$('#imageShapeReview').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/shapes/product-3-E.png');
			$('#imageStyleReview').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/shape-structure/product-3-E-waterfall.png');
			$('#imageDimensionReview').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/shape-structure/product-3-E-waterfall.png');
			$('#imageCoverReview').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/shape-structure/product-3-E-waterfall.png');
			$('#imageFillReview').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/shape-structure/product-3-E-waterfall.png');
			$('#imageTieReview').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/shape-structure/product-3-E-waterfall.png');
			$('#imageConfirmReview').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/shape-structure/product-3-E-waterfall.png');
			$('#imageShowingDimension').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/rounded.png');

			// set shape to tie similar to selected shape
			$('.ties1').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/tie/round/tie-1.png');
			$('.ties2').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/tie/round/tie-2.png');
			$('.ties4').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/tie/round/tie-3.png');
			...
			break;
		case 6:
			$('#imageShapeReview').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/shapes/product-3-F.png');
			$('#imageStyleReview').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/shape-structure/product-3-F-boxed.png');
			$('#imageDimensionReview').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/shape-structure/product-3-F-boxed.png');
			$('#imageCoverReview').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/shape-structure/product-3-F-boxed.png');
			$('#imageFillReview').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/shape-structure/product-3-F-boxed.png');
			$('#imageTieReview').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/shape-structure/product-3-F-boxed.png');
			$('#imageConfirmReview').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/shape-structure/product-3-F-boxed.png');
			$('#imageShowingDimension').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/trapezoidal.png');

			// set shape to tie similar to selected shape
			$('.ties1').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/tie/trapezoid/tie-1.png');
			$('.ties2').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/tie/trapezoid/tie-2.png');
			$('.ties3').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/tie/trapezoid/tie-3.png');
			$('.ties4').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/tie/trapezoid/tie-4.png');
			$('.ties5').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/tie/trapezoid/tie-5.png');
			$('.ties6').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/tie/trapezoid/tie-6.png');
...
var setStyleReviewImage = (c) => {
	switch (c) {
		case 1:
			...
			$('#imageStyleReview').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/shape-structure/' + imageName);
			$('#imageDimensionReview').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/shape-structure/' + imageName);
			$('#imageCoverReview').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/shape-structure/' + imageName);
			$('#imageFillReview').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/shape-structure/' + imageName);
			$('#imageTieReview').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/shape-structure/' + imageName);
			$('#imageConfirmReview').attr("src", WEB_URL + '/assets/images/stepper/product-three-b/shape-structure/' + imageName);
