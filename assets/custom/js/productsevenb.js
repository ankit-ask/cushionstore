$(document).ready(function () {
	...
	$('#imageDimensionReview').attr("src", WEB_URL + '/assets/images/stepper/product-seven-b/shapes/product-7-A.png');
	$('#imageCoverReview').attr("src", WEB_URL + '/assets/images/stepper/product-seven-b/shapes/product-7-A.png');
	$('#imageFillReview').attr("src", WEB_URL + '/assets/images/stepper/product-seven-b/shapes/product-7-A.png');
	$('#imageTieReview').attr("src", WEB_URL + '/assets/images/stepper/product-seven-b/shapes/product-7-A.png');
	$('#imageConfirmReview').attr("src", WEB_URL + '/assets/images/stepper/product-seven-b/shapes/product-7-A.png');
	$('#imageShowingDimension').attr("src", WEB_URL + '/assets/images/stepper/product-seven-b/round.png');

	var data = {
		'product-7':
		{
			'dimension': { 'thickness': 2, 'diameter': 10},
			'cover': { 'trimming': 'No', 'fabric': 'Test Name 1' },
			'fill': { 'type': 'Polyurethane Foam' },
			'ties': { 'type': 'None' },
			'productName': 'Custom Round Daybed Cushion'
		}
	}
	...
	$('#diameter').change(function () {
		...
		fetchedData['product-7'].dimension.diameter = diameter;
...
function setDataToReview() {
	...
	dimensions.innerHTML = fetchedData['product-7'].dimension.diameter + ' Diameter' + ' x ' + fetchedData['product-7'].dimension.thickness + ' Thick';
}
