$(document).ready(function () {
	...
	$('#imageShapeReview').attr("src", WEB_URL + '/assets/images/stepper/product-two/shapes/product-2-A.png');
	$('#imageStyleReview').attr("src", WEB_URL + '/assets/images/stepper/product-two/shape-structure/product-2-A-waterfall.png');
	$('#imageDimensionReview').attr("src", WEB_URL + '/assets/images/stepper/product-two/shape-structure/product-2-A-waterfall.png');
	$('#imageCoverReview').attr("src", WEB_URL + '/assets/images/stepper/product-two/shape-structure/product-2-A-waterfall.png');
	$('#imageFillReview').attr("src", WEB_URL + '/assets/images/stepper/product-two/shape-structure/product-2-A-waterfall.png');
	$('#imageTieReview').attr("src", WEB_URL + '/assets/images/stepper/product-two/shape-structure/product-2-A-waterfall.png');
	$('#imageConfirmReview').attr("src", WEB_URL + '/assets/images/stepper/product-two/shape-structure/product-2-A-waterfall.png');
	$('#imageShowingDimension').attr("src", WEB_URL + '/assets/images/stepper/product-two/seat-selet-square.png');
...
var setShapeReviewImage = (c) => {
	switch (c) {
		case 1:
			...
			$('.ties1').attr("src", WEB_URL + '/assets/images/stepper/product-two/tie/square/tie-1.png');
			$('.ties2').attr("src", WEB_URL + '/assets/images/stepper/product-two/tie/square/tie-2.png');
			$('.ties3').attr("src", WEB_URL + '/assets/images/stepper/product-two/tie/square/tie-3.png');
			$('.ties4').attr("src", WEB_URL + '/assets/images/stepper/product-two/tie/square/tie-4.png');
			$('.ties5').attr("src", WEB_URL + '/assets/images/stepper/product-two/tie/square/tie-5.png');
			$('.ties6').attr("src", WEB_URL + '/assets/images/stepper/product-two/tie/square/tie-6.png');
			...
			break;
		case 2:
			$('#imageShapeReview').attr("src", WEB_URL + '/assets/images/stepper/product-two/shapes/product-2-B.png');
			$('#imageStyleReview').attr("src", WEB_URL + '/assets/images/stepper/product-two/shape-structure/product-2-B-waterfall.png');
			$('#imageDimensionReview').attr("src", WEB_URL + '/assets/images/stepper/product-two/shape-structure/product-2-B-waterfall.png');
			$('#imageCoverReview').attr("src", WEB_URL + '/assets/images/stepper/product-two/shape-structure/product-2-B-waterfall.png');
			$('#imageFillReview').attr("src", WEB_URL + '/assets/images/stepper/product-two/shape-structure/product-2-B-waterfall.png');
			$('#imageTieReview').attr("src", WEB_URL + '/assets/images/stepper/product-two/shape-structure/product-2-B-waterfall.png');
			$('#imageConfirmReview').attr("src", WEB_URL + '/assets/images/stepper/product-two/shape-structure/product-2-B-waterfall.png');
			$('#imageShowingDimension').attr("src", WEB_URL + '/assets/images/stepper/product-two/top-rounded-corners.png');

			// set shape to tie similar to selected shape
			$('.ties1').attr("src", WEB_URL + '/assets/images/stepper/product-two/tie/rounded-back-corners/tie-1.png');
			$('.ties2').attr("src", WEB_URL + '/assets/images/stepper/product-two/tie/rounded-back-corners/tie-2.png');
			$('.ties3').attr("src", WEB_URL + '/assets/images/stepper/product-two/tie/rounded-back-corners/tie-3.png');
			$('.ties4').attr("src", WEB_URL + '/assets/images/stepper/product-two/tie/rounded-back-corners/tie-4.png');
			$('.ties5').attr("src", WEB_URL + '/assets/images/stepper/product-two/tie/rounded-back-corners/tie-5.png');
			$('.ties6').attr("src", WEB_URL + '/assets/images/stepper/product-two/tie/rounded-back-corners/tie-6.png');
			...
			break;
		case 3:
			$('#imageShapeReview').attr("src", WEB_URL + '/assets/images/stepper/product-two/shapes/product-2-C.png');
			$('#imageStyleReview').attr("src", WEB_URL + '/assets/images/stepper/product-two/shape-structure/product-2-C-waterfall.png');
			$('#imageDimensionReview').attr("src", WEB_URL + '/assets/images/stepper/product-two/shape-structure/product-2-C-waterfall.png');
			$('#imageCoverReview').attr("src", WEB_URL + '/assets/images/stepper/product-two/shape-structure/product-2-C-waterfall.png');
			$('#imageFillReview').attr("src", WEB_URL + '/assets/images/stepper/product-two/shape-structure/product-2-C-waterfall.png');
			$('#imageTieReview').attr("src", WEB_URL + '/assets/images/stepper/product-two/shape-structure/product-2-C-waterfall.png');
			$('#imageConfirmReview').attr("src", WEB_URL + '/assets/images/stepper/product-two/shape-structure/product-2-C-waterfall.png');
			$('#imageShowingDimension').attr("src", WEB_URL + '/assets/images/stepper/product-two/all-rounded-corners.png');

			// set shape to tie similar to selected shape
			$('.ties1').attr("src", WEB_URL + '/assets/images/stepper/product-two/tie/all-corners-rounded/tie-1.png');
			$('.ties2').attr("src", WEB_URL + '/assets/images/stepper/product-two/tie/all-corners-rounded/tie-2.png');
			$('.ties3').attr("src", WEB_URL + '/assets/images/stepper/product-two/tie/all-corners-rounded/tie-3.png');
			$('.ties4').attr("src", WEB_URL + '/assets/images/stepper/product-two/tie/all-corners-rounded/tie-4.png');
			$('.ties5').attr("src", WEB_URL + '/assets/images/stepper/product-two/tie/all-corners-rounded/tie-5.png');
			$('.ties6').attr("src", WEB_URL + '/assets/images/stepper/product-two/tie/all-corners-rounded/tie-6.png');
			...
			break;
		case 4:
			$('#imageShapeReview').attr("src", WEB_URL + '/assets/images/stepper/product-two/shapes/product-2-D.png');
			$('#imageStyleReview').attr("src", WEB_URL + '/assets/images/stepper/product-two/shape-structure/product-2-D-waterfall.png');
			$('#imageDimensionReview').attr("src", WEB_URL + '/assets/images/stepper/product-two/shape-structure/product-2-D-waterfall.png');
			$('#imageCoverReview').attr("src", WEB_URL + '/assets/images/stepper/product-two/shape-structure/product-2-D-waterfall.png');
			$('#imageFillReview').attr("src", WEB_URL + '/assets/images/stepper/product-two/shape-structure/product-2-D-waterfall.png');
			$('#imageTieReview').attr("src", WEB_URL + '/assets/images/stepper/product-two/shape-structure/product-2-D-waterfall.png');
			$('#imageConfirmReview').attr("src", WEB_URL + '/assets/images/stepper/product-two/shape-structure/product-2-D-waterfall.png');
			$('#imageShowingDimension').attr("src", WEB_URL + '/assets/images/stepper/product-two/rounded-back.png');
		...
		case 5:
			...
			// set shape to tie similar to selected shape
			$('.ties1').attr("src", WEB_URL + '/assets/images/stepper/product-two/tie/round/tie-1.png');
			$('.ties2').attr("src", WEB_URL + '/assets/images/stepper/product-two/tie/round/tie-2.png');
			$('.ties4').attr("src", WEB_URL + '/assets/images/stepper/product-two/tie/round/tie-3.png');
			...
			break;
		case 6:
			$('#imageShapeReview').attr("src", WEB_URL + '/assets/images/stepper/product-two/shapes/product-2-F.png');
			$('#imageStyleReview').attr("src", WEB_URL + '/assets/images/stepper/product-two/shape-structure/product-2-F-boxed.png');
			$('#imageDimensionReview').attr("src", WEB_URL + '/assets/images/stepper/product-two/shape-structure/product-2-F-boxed.png');
			$('#imageCoverReview').attr("src", WEB_URL + '/assets/images/stepper/product-two/shape-structure/product-2-F-boxed.png');
			$('#imageFillReview').attr("src", WEB_URL + '/assets/images/stepper/product-two/shape-structure/product-2-F-boxed.png');
			$('#imageTieReview').attr("src", WEB_URL + '/assets/images/stepper/product-two/shape-structure/product-2-F-boxed.png');
			$('#imageConfirmReview').attr("src", WEB_URL + '/assets/images/stepper/product-two/shape-structure/product-2-F-boxed.png');
			$('#imageShowingDimension').attr("src", WEB_URL + '/assets/images/stepper/product-two/trapezoidal.png');

			// set shape to tie similar to selected shape
			$('.ties1').attr("src", WEB_URL + '/assets/images/stepper/product-two/tie/trapezoid/tie-1.png');
			$('.ties2').attr("src", WEB_URL + '/assets/images/stepper/product-two/tie/trapezoid/tie-2.png');
			$('.ties3').attr("src", WEB_URL + '/assets/images/stepper/product-two/tie/trapezoid/tie-3.png');
			$('.ties4').attr("src", WEB_URL + '/assets/images/stepper/product-two/tie/trapezoid/tie-4.png');
			$('.ties5').attr("src", WEB_URL + '/assets/images/stepper/product-two/tie/trapezoid/tie-5.png');
			$('.ties6').attr("src", WEB_URL + '/assets/images/stepper/product-two/tie/trapezoid/tie-6.png');
